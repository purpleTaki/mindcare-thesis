  ...
  <div class="item">
    <div class="item-bg">
      <img src="../pos/assets/theme/images/a1.jpg" class="blur opacity-3">
    </div>
    <div class="p-a-md">
      <div class="row m-t">
        <div class="col-sm-7">
          <a href class="pull-left m-r-md">
            <span class="avatar w-96">
              <img src="../pos/assets/theme/images/a1.jpg">
        ...
        <div class="tab-content">      
          <div class="tab-pane p-v-sm active" id="tab_1">
            <div class="streamline b-l m-b m-l">
              ...
              <div class="sl-item">
                <div class="sl-left">
                  <img src="../pos/assets/theme/images/a1.jpg" class="img-circle">
                </div>
                <div class="sl-content">
              ...
              <div class="sl-item">
                <div class="sl-left">
                  <img src="../pos/assets/theme/images/a4.jpg" class="img-circle">
                </div>
                <div class="sl-content">
