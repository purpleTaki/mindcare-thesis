      ...
      <div>
        ...
        <div class="list white">
          ...
          <div class="list-item b-l b-l-2x b-primary">
            <div class="list-left">
              <span class="w-40 avatar">
                <img src="../pos/assets/theme/images/a2.jpg">
              </span>
            </div>
            <div class="list-body">
              <div class="pull-right text-muted text-xs">
          ...
          <div class="list-item b-l b-l-2x">
            <div class="list-left">
              <span class="w-40 avatar">
                <img src="../pos/assets/theme/images/a5.jpg">
              </span>
            </div>
            <div class="list-body">
              <div class="pull-right text-muted text-xs">
          ...
          <div class="list-item b-l b-l-2x b-warn">
            <div class="list-left">
              <span class="w-40 avatar">
                <img src="../pos/assets/theme/images/a6.jpg">
              </span>
            </div>
            <div class="list-body">
              <div class="pull-right text-muted text-xs">
          ...
          <div class="list-item b-l b-l-2x">
            <div class="list-left">
              <span class="w-40 avatar">
                <img src="../pos/assets/theme/images/a7.jpg">
              </span>
            </div>
            <div class="list-body">
              <div class="pull-right text-muted text-xs">
          ...
          <div class="list-item b-l b-l-2x b-success">
            <div class="list-left">
              <span class="w-40 avatar">
                <img src="../pos/assets/theme/images/a8.jpg">
              </span>
            </div>
            <div class="list-body">
              <div class="pull-right text-muted text-xs">
          ...
          <div class="list-item b-l b-l-2x">
            <div class="list-left">
              <span class="w-40 avatar">
                <img src="../pos/assets/theme/images/a9.jpg">
              </span>
            </div>
            <div class="list-body">
              <div class="pull-right text-muted text-xs">
