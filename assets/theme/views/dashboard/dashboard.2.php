					...
					<div class="box">
						...
						<ul class="list-group no-border m-b">
					        <li class="list-group-item">
					          <a href="" class="pull-left w-40 m-r"><img src="../pos/assets/theme/images/a8.jpg" class="img-responsive img-circle"></a>
					          <div class="clear">
		...
		<div class="p-a b-b">
			<a href class="clear">
			    <span class="pull-left">
			      <img src="../pos/assets/theme/images/a1.jpg" alt="..." class="w-40 r">
			    </span>
