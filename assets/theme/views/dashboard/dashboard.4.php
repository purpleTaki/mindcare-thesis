	    	...
	    	<div class="box">
	    		...
	    		<div class="box-body">
	    			<div class="row row-sm">
	    				<div class="col-xs-4">
	    					<a href>
	    						<img src="../pos/assets/theme/images/c6.jpg" class="w-full"></img>
	    					</a>
	    				</div>
	    				<div class="col-xs-4">
	    					<a href>
	    						<img src="../pos/assets/theme/images/c4.jpg" class="w-full"></img>
	    					</a>
	    				</div>
	    				<div class="col-xs-4">
	    					<a href>
	    						<img src="../pos/assets/theme/images/c5.jpg" class="w-full"></img>
	    					</a>
	    				</div>
	    			</div>
	    		</div>
		                  ...
		                  <div>
		                    ...
		                    <p>
		                      <span class="inline p-a-xs b-a dark-white">
		                        <img src="../pos/assets/theme/images/b2.jpg" class="img-responsive">
		                      </span>
		                    </p>
		                  </div>
		                </div>
		...
		<div class="col-sm-6 pull-md-6 col-md-3">
			<div class="box">
			    ...
			    <div class="p-a-md text-center">
			    	<p><img src="../pos/assets/theme/images/a1.jpg" class="img-circle w-xs"></p>
			    	...
			    	<div class="text-center m-t">
			    		<a href class="btn btn-sm rounded {{app.setting.theme.primary}} w-sm m-y-xs">Follow</a>
			    		<a href class="btn btn-sm rounded btn-outline b-{{app.setting.theme.primary}} w-sm">Invite</a>
			    	</div>
			    </div>
			...
			<div class="box light lt">
	            <div class="box-body">
	              <a href class="pull-left m-r">
	                <img src="../pos/assets/theme/images/a0.jpg" class="img-circle w-40">
	              </a>
	    	...
	    	<div class="box">
				...
				<div class="list-group no-radius no-borders">
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		                ...
		                <img src="../pos/assets/theme/images/a2.jpg" class="w-24 m-r-sm img-circle">
		                <span>Jonathan Morina</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm success"></span>
		                <img src="../pos/assets/theme/images/a3.jpg" class="w-24 m-r-sm img-circle">
		                <span>Mason Yarnell</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm warning"></span>
		                <img src="../pos/assets/theme/images/a4.jpg" class="w-24 m-r-sm img-circle">
		                <span>Mike Mcalidek</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm danger"></span>
		                <img src="../pos/assets/theme/images/a5.jpg" class="w-24 m-r-sm img-circle">
		                <span>Cris Labiso</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm dker"></span>
		                <img src="../pos/assets/theme/images/a6.jpg" class="w-24 m-r-sm img-circle">
		                <span>Daniel Sandvid</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm dker"></span>
		                <img src="../pos/assets/theme/images/a7.jpg" class="w-24 m-r-sm img-circle">
		                <span>Helder Oliveira</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm dker"></span>
		                <img src="../pos/assets/theme/images/a8.jpg" class="w-24 m-r-sm img-circle">
		                <span>Jeff Broderik</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm dker"></span>
		                <img src="../pos/assets/theme/images/a9.jpg" class="w-24 m-r-sm img-circle">
		                <span>Daniel Sandvid</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm dker"></span>
		                <img src="../pos/assets/theme/images/a0.jpg" class="w-24 m-r-sm img-circle">
		                <span>Helder Oliveira</span>
		            </a>
		            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
		            	<span class="w-8 rounded m-r-sm dker"></span>
