			...
			<div class="row">
				<div class="col-xs-6 col-sm-12 col-md-6">
					<div class="box">
					    <div class="item">
						    <div class="item-bg">
						      <img src="../pos/assets/theme/images/a3.jpg" class="blur">
						    </div>
						    <div class="p-a-lg pos-rlt text-center">
						    	<img src="../pos/assets/theme/images/a3.jpg" class="img-circle w-56" style="margin-bottom: -7rem">
						    </div>
						</div>
					    <div class="p-a text-center">
					    	<a href class="text-md m-t block">Jack Perez</a>
					    	<p><small>Designer, Blogger</small></p>
					    	<p><a href class="btn btn-sm {{app.setting.theme.primary}}">Follow</a></p>
					    	<div class="text-xs">
				  ...
				  <div class="box">
				    <div class="item">
					    <div class="item-bg {{app.setting.theme.primary}} h6">
					    	<p class="p-a">"We are creating a awesome project for our client!"</p>
					    </div>
					    <div class="p-a p-y-lg pos-rlt">
					    	<img src="../pos/assets/theme/images/a0.jpg" class="img-circle w-56" style="margin-bottom: -7rem">
					    </div>
					</div>
				    <div class="p-a">
				    	<a href class="text-md m-t block">Jason Warren</a>
				    	<p><small>London, UK</small></p>
				    	<p><a href class="btn btn-sm rounded warn">Follow</a></p>
				    	<div class="text-xs">
				    		<i class="fa fa-fw fa-twitter"></i> 
				    		<strong>540</strong> 
				    		<i class="fa fa-fw fa-facebook m-l-sm"></i> 
				    		<strong>560</strong>
				    	</div>
				    </div>
				  </div>
				...
				<div class="col-xs-6 col-sm-12 col-md-6">
				  <div class="box text-center">
				    ...
				    <div class="p-a-md">
				    	<p><img src="../pos/assets/theme/images/a1.jpg" class="img-circle w-56"></p>
				...
				<div class="col-xs-6 col-sm-12 col-md-6">
				  <div class="box text-center">
				    ...
				    <div class="p-a-md">
				    	<p><img src="../pos/assets/theme/images/a4.jpg" class="img-circle w-56"></p>
				    	<a href class="text-md block">Kyle Kelley</a>
				    	<p><small>London, UK</small></p>
				    	<a href class="btn btn-sm btn-outline rounded b-accent">Follow</a>
				    </div>
				    <div class="row row-col no-gutter b-t {{app.setting.theme.warn}}">
					  <div class="col-xs-4 b-r">
				...
				<div class="col-xs-6 col-sm-12 col-md-6 col-0">
					<div class="box">
						<div class="item">
							...
							<img src="../pos/assets/theme/images/c2.jpg" class="w-full">
						</div>
						<div class="p-a">
				...
				<div class="col-xs-6 col-sm-12 col-md-6">
					<div class="box">
						<div class="item dark">
						    <a href><img src="../pos/assets/theme/images/c6.jpg" class="w-full"></a>
					...
					<div class="box">
			            ...
			            <ul class="list no-border p-b">
			              <li class="list-item">
			                <a herf class="list-left">
			                	<span class="w-40 avatar">
				                  <img src="../pos/assets/theme/images/a4.jpg" alt="...">
			              ...
			              <li class="list-item">
			                <a herf class="list-left">
			                	<span class="w-40 avatar">
				                  <img src="../pos/assets/theme/images/a5.jpg" alt="...">
				                  <i class="on b-white bottom"></i>
				                </span>
			                </a>
			                <div class="list-body">
			              ...
			              <li class="list-item">
			                <a herf class="list-left">
			                	<span class="w-40 avatar">
				                  <img src="../pos/assets/theme/images/a6.jpg" alt="...">
			              ...
			              <li class="list-item">
			                <a herf class="list-left">
			                	<span class="w-40 avatar">
				                  <img src="../pos/assets/theme/images/a7.jpg" alt="...">
			            ...
			            <ul class="list no-border">
			              <li class="list-item">
			                <a herf class="pull-left m-r">
			                	<span class="w-40">
			                  		<img src="../pos/assets/theme/images/b1.jpg" class="w-full" alt="...">
			                 	</span>
			                </a>
			                <div class="clear">
			              ...
			              <li class="list-item">
			                <a herf class="pull-left m-r">
				                <span class="w-40">
			                  		<img src="../pos/assets/theme/images/b2.jpg" class="w-full" alt="...">
			                 	</span>
			                </a>
			                <div class="clear">
			              ...
			              <li class="list-item">
			                <a herf class="pull-left m-r">
			                    <span class="w-40">
			                  		<img src="../pos/assets/theme/images/b3.jpg" class="w-full" alt="...">
			                 	</span>
			                </a>
			                <div class="clear">
			              ...
			              <li class="list-item">
			                <a herf class="pull-left m-r">
			                    <span class="w-40">
			                  		<img src="../pos/assets/theme/images/b4.jpg" class="w-full" alt="...">
			                 	</span>
			                </a>
			                <div class="clear">
			              ...
			              <li class="list-item">
			                <a herf class="pull-left m-r">
			                    <span class="w-40">
			                  		<img src="../pos/assets/theme/images/b5.jpg" class="w-full" alt="...">
			                 	</span>
			                </a>
			                <div class="clear">
				...
				<div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body">
				              ...
				              <div class="sl-item">
				                <div class="sl-left">
				                  <img src="../pos/assets/theme/images/a0.jpg" class="img-circle">
				                </div>
				              ...
				              <div class="sl-item">
				                <div class="sl-left">
				                  <img src="../pos/assets/theme/images/a2.jpg" class="img-circle">
				                </div>
				                <div class="sl-content">
				                  ...
				                  <div>
				                    ...
				                    <p>
				                      <span class="inline p-a-xs b dark-white">
				                        <img src="../pos/assets/theme/images/c1.jpg" class="img-responsive">
				                      </span>
				                    </p>
				                  </div>
				                </div>
				              ...
				              <div class="sl-item">
				                <div class="sl-left">
				                  <img src="../pos/assets/theme/images/a3.jpg" class="img-circle">
				                </div>
				                <div class="sl-content">
					              ...
					              <div class="sl-item">
					                <div class="sl-left">
					                  <img src="../pos/assets/theme/images/a5.jpg" class="img-circle">
					                </div>
					                <div class="sl-content">
				...
				<div class="col-sm-12">
					<div class="box">
						...
						<div class="box-body">
				              ...
				              <div class="sl-item">
				                <div class="sl-left">
				                  <img src="../pos/assets/theme/images/a8.jpg" class="img-circle">
				                </div>
				                <div class="sl-content">
				            ...
				            <a href class="btn btn-sm success text-u-c m-y-sm">Load More</a>
				  		</div>
					</div>
				</div>
				...
				<div class="col-sm-12">
					<div class="box">
						<div class="item">
							...
							<img src="../pos/assets/theme/images/c7.jpg" class="w-full">
						</div>
						<div class="p-a">
							<div class="text-muted m-b-xs">
								<a href class="m-r"><i class="fa fa-heart-o"></i> 34</a>
							...
							<div class="m-b h-3x">
								...
								<a href><img src="../pos/assets/theme/images/a0.jpg" class="w-32 rounded"></a>
								<a href><img src="../pos/assets/theme/images/a1.jpg" class="w-32 rounded"></a>
								<a href><img src="../pos/assets/theme/images/a2.jpg" class="w-32 rounded"></a>
								<a href><img src="../pos/assets/theme/images/a3.jpg" class="w-32 rounded"></a>
					...
					<div class="box">
			            ...
			            <ul class="list inset m-a-0">
			              ...
			              <li class="list-item">
			                <a herf class="list-left">
			                  <span class="w-40 avatar">
				                  <img src="../pos/assets/theme/images/a8.jpg" alt="...">
				                  <i class="on b-white left"></i>
				              </span>
			                </a>
			                <div class="list-body">
			              ...
			              <li class="list-item">
			                <a herf class="list-left">
			                  <span class="w-40 avatar">
				                  <img src="../pos/assets/theme/images/a9.jpg" alt="...">
					          ...
					          <div class="p-a-md">
					            <div class="m-b">
					              <a href class="pull-left w-40 m-r-sm">
					              	<img src="../pos/assets/theme/images/a2.jpg" alt="..." class="w-full img-circle">
					              </a>
					              <div class="clear">
					              	<div>
					            ...
					            <div class="m-b">
					              <a href class="pull-right w-40 m-l-sm">
					              	<img src="../pos/assets/theme/images/a3.jpg" class="w-full img-circle" alt="...">
					              </a>
