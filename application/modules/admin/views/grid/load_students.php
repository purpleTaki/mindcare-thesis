...
?>
            <tr>
                ...
                <td class="text-center">
                    <button class="btn btn-warning edit-btn" data-id="<?= $val->ID ?>" data-fname="<?= $val->fname ?>" data-mname="<?= $val->mname ?>" data-lname="<?= $val->lname ?>" data-uname="<?= $val->username ?>" data-course="<?= $val->yearSection ?>" data-email="<?= $val->email ?>"><i class="fas fa-pen"></i>Edit</button>
